...
<body>
    <h2 class= "frase"> ¡Descubre el mundo a tu manera, planea tu viaje perfecto con nosotros! </h2>
    <nav>
    ...
    <main class="gradient-border">
        <div class="logo">
            <img src="../multimedia/logoo.png" alt="dreamroutes" width="450" height="350" />
        </div>
        <div class="wsp">
        ...
        <div class="box">
            <h1 class="frasecontac">CONTACTO</h1>
            <div class="box2">
                <div class="map-container">
                  <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3977.0073593269603!2d-74.16309132506994!3d4.5927012953819295!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8e3f9efce9393831%3A0xaae45881440a31d4!2sMadelena%20Urbano%201!5e0!3m2!1ses!2sco!4v1686624705568!5m2!1ses!2sco" 
                  allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>
            <p class="datos">
                <br>
                Celular: 3184932909<br>
                <br>
                Email: nukoluks@hotmail.com<br>
                <br>
                Ubicación: <br>
                <br>
                Calle 60sur #68b-39 torre 4 apto 1806<br>
                <br>
                Conjunto madelena urbano 1<br>
                <br>
                Bogotá, Colombia
              </p>           
        </div>
