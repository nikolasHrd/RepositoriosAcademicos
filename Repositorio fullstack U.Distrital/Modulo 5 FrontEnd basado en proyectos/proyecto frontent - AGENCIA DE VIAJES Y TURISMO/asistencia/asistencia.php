...
<body>
    ...
    <main class="gradient-border">
        ...
        <div class="box">
            <h2 class="frase2"> ¡TARJETA DE ASISTENCIA! </h2>
            <div class="frio3" >
                <img  src="../asistencia/seguro.jpg">
            </div>
            <p class="frio">
                Nuestra tarjeta de asistencia <br>
                es una herramienta para que su<br>
                viaje sea seguro y placentero esta <br>
                tarjeta contiene los siguientes items<br><br>
                Seguro de vida: 100USD  <br>
                Salud de servicio prepagado: 150USD
              </p>
              <p class="preciofrio">PLAN  x 250USD</p>
              <a href="../carrito/carrito.php" class="comprar-btn">Comprar ahora</a>
        </div>
        <div class="box2">
            <h2 class="frase3">¡ALQUILER DE VEHICULO!</h2>
            <div class="ORLANDO" >
                <img  src="../asistencia/Alquiler.jpg">
            </div>
            <p class="actividades">
              Usted podra alquilar y tener <br>
              a su disposicion los siguienres  <br>
              vehiculos, recuerde que su eleccion<br>
              depende del destino.<br><br>
              Automovil: DIA x 40USD <br>
              Camioneta: DIA x 60USD <br>
              Motocicleta: DIA x 35USD
            </p>
            <a href="../carrito/carrito.php" class="comprar-btn">Comprar ahora</a>
          </div>
      </main>
