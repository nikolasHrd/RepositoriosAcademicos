...
<body>
    ...
    <main class="gradient-border">
        ...
        <div class="box">
            <h2 class="frase2"> ¡DESCANSA CURAZAO! </h2>
            <div class="frio3" >
                <img  src="../ofertas/curazao.jpg">
            </div>
            <p class="frio">
                4 dias y 3 noches en las playas mas maravillosas de <br>
                curazao un plan perfecto que incluye:<br><br>

                Incluye alojamiento, traslados, alimentación.<br>
              </p>
              <p class="preciofrio">PLAN  x 500USD</p>
              <a href="../carrito/carrito.php" class="comprar-btn">Comprar ahora</a>
        </div>
        <div class="box2">
            <h2 class="frase3">¡ALQUILER DE VEHICULO!</h2>
                <section>
                    <img  src="../ofertas/europa.jpg">
                    <img  src="../ofertas/asia.jpg">
                    <img  src="../ofertas/USA.jpg">
                    <img  src="../ofertas/amazonas.jpg">
                    <img  src="../ofertas/africa.jpg">
                </section>
            <p class="actividades">
              EUROPA PLAN X 600USD<br><br>
              ASIA PLAN X 600USD<br><br>
              USA PLAN X 600USD<br><br>
              AMAZONAS PLAN X 600USD<br><br>
              AFRICA PLAN X 600USD<br>
            </p>
            <a href="../carrito/carrito.php" class="comprar-btn">Comprar ahora</a>
          </div>
      </main>
