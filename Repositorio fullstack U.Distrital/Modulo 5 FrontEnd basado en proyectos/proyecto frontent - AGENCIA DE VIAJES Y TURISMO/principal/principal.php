...
<body>
    ...
    <main class="gradient-border">
        ...
        <div class="box">
            ...
            <iframe width="100%" height="100%" src="https://www.youtube.com/embed/icMPQ84mG1Y" title="YouTube video player" frameborder="0" 
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen style="position: relative; z-index: 999;"></iframe>
        </div>
